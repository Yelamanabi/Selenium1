...
public class ActionClassTest extends TestBase {
    ...
    public void testHoverAction(){
        ...
        //hover over to 1as image , paused 2 second , then second imaje paused 2 second
        //then hover over to 1st image again , paused 2 second then image paused 2 second
        //perform the action
